        ...
        {/* Item 1 */}
          <div className="features-item">
            <div className="features-text">
              ...
              <p> An in-depth analysis of AI policies, regulations, and governance frameworks across African nations. </p>
              <a href="#" className="btn btn-get-started">Download PDF</a>
            </div>
          ...
          <div className="features-item reverse">
            <div className="features-text">
              ...
              <p> Stay informed with the latest updates, insights, and events shaping AI across Africa. Subscribe to our weekly newsletter and never miss out. </p>
              <ul>
                <li>Curated AI news and policy updates</li>
                <li>Expert insights and analysis</li>
                <li>Upcoming events and opportunities</li>
              </ul>
              <a href="#" className="btn btn-get-started">Subscribe Now</a>
            </div>
            <div className="features-img">
          ...
          <div className="features-item">
            <div className="features-text">
              ...
              <p> Explore insightful articles on AI governance, fairness, transparency, and inclusive design — guiding the responsible use of artificial intelligence in Africa and beyond. </p>
              <a href="blog/ethical-ai.html" className="btn btn-get-started">Read Articles</a>
            </div>
            <div className="features-img">
